/*
this project also can  be viewed online on 

on PC
https://berlinali.github.io/pcgamebot/

on android phone.
https://berlinali.github.io/mobilegamebot/

on iphone,
https://berlinali.github.io/iphonegamebot/
*/
...
var framePlaying;
var frameEnd;
var title = "Sound Reactive Mini Game"
var startText = "Tab the screen to play!"
var timeText = "It has played";
var endText1 = "Game over! Your score is ";
var endText2 = "Tab the screen to play again!";
var winText1 = "Congrats! Your score is ";
var winText2 = "Tab the screen to play again!";
var bgdMusic;
var hitSound;
var scoreSound;
var winSound;
...
function beginText(){
	...
	stroke(0);
	strokeWeight(6);
	text(title,0,0,width,height-200);
	strokeWeight(3);
	textSize(20);
	textStyle(ITALIC);
	if(frameCount % 60 < 45){
...
function loseText(){
	...
	strokeWeight(6);
	textSize(30);
	text(endText1+score+".",0,0,width,height-250);
...
function winText(){
	...
	textAlign(CENTER,CENTER);
	textSize(30);
	text(winText1+score+".",0,0,width,height-250);
	text("It has played"+" "+timer+" secs.",0,0,width,height-100);
	textSize(20);
	strokeWeight(3);
	if(frameCount % 60 < 45){
